...
public final class ActivityTermsBinding implements ViewBinding {
  ...
  private ActivityTermsBinding(@NonNull ConstraintLayout rootView, @NonNull TextView TvTerms) {
  ...
  public static ActivityTermsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTermsBinding((ConstraintLayout) rootView, TvTerms);
    }
