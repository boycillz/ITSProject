...
public final class ActivityPrivacyBinding implements ViewBinding {
  ...
  private ActivityPrivacyBinding(@NonNull ConstraintLayout rootView, @NonNull TextView TvPrivacy) {
  ...
  public static ActivityPrivacyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPrivacyBinding((ConstraintLayout) rootView, TvPrivacy);
    }
